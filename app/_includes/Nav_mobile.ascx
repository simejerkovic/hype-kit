<div id="nav-mobile" class="c-nav-mobile" role="navigation" aria-label="Mobile navigation">
  <a href="<%= NavigateUrl(PortalSettings.HomeTabId) %>" class="c-logo c-logo--black"></a>
  ...
  FooterTemplate='</ul>' SeparatorTemplate='/' />
    <dnn:menu id="navMobile" menustyle="mobile-nav" NodeSelector="*,0,1" ExcludeNodes="236,248,250,256" runat="server"></dnn:menu>
    <dnn:menu id="navMobileEn" menustyle="mobile-nav" NodeSelector="225,0,0" ExcludeNodes="" runat="server"></dnn:menu>
  </nav>
</div>
